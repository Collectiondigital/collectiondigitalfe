                ...
                <div className="sb__footer-padding">
                  ...
                  >
                    <p className="disclaim">
                      The Data used on this Website is provided by V&A
                      Collection Click{" "}
                      <a
                ...
                <div className="sb__footer-below">
                  <div className="sb__footer-copyright">
                    ...
                    <p style={{ marginTop: "4px" }}>
                      Rights to all collection images & data belong to the V&A
                      Museum London.
                    </p>
                    <p style={{ marginTop: "3px" }}>
                      This website was designed and built by Sona Chaboud,
